...
Maximize
 ...
 - 0.75 subprod_exces(extra)

Subject To
 temps(P1): + 6 taronjada(lleugera) + 8 taronjada(extra) <= 350
 temps(P2): + 4 taronjada(lleugera) + 3 taronjada(extra) <= 300
 temps(P3): + 5 taronjada(lleugera) + 4 taronjada(extra) <= 320
